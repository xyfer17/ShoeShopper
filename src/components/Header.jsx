...
const Header = () => {
  ...
  window.addEventListener("scroll", changeVal);

  const toggleMenu = () => menuRef.current.classList.toggle("show__menu");

  return (
    <header>
      <div className="pre_header   align-items-center justify-content-between">
        <div className="pre_header-logo">
        ...
        <div className="usermenu">
          <span>Find a Store</span>|<span>Help</span>|<span>Join Us</span>|
          <span>Sign In</span>
        </div>
      </div>
      <div
        className={
          headTop
            ? "  sticky  d-flex align-items-center justify-content-between"
      ...
      >
        ...
        <div className="navigation" ref={menuRef} onClick={toggleMenu}>
          <ul className="menu_list d-flex align-items-center gap-4">
            <li className="menu-item">New & Featured</li>
            <li className="menu-item">Men</li>
            <li className="menu-item">Women</li>
            <li className="menu-item">Kids</li>
            <li className="menu-item">Sale</li>
            <li className="menu-item">SNKRS</li>
          </ul>
        </div>
