...
const nav_links = [
  { display: "New & Featured", path: "/home" },
  { display: "Men", path: "/foods" },
  { display: "Women", path: "/cart" },
  { display: "Kids", path: "/contact" },
  { display: "Sale", path: "/contact" },
  { display: "SNKRS", path: "/contact" },
];
const Header = () => {
